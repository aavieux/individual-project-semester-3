...
public interface LibraryRepository extends JpaRepository<Library, Long> {
    ...
    public Optional<Library> getLibraryByIdByUser(@Param("library_id_p") Long library_id, @Param("authenticatedUser_id_p") Long authenticatedUser_id);
    @Query(value = "SELECT * FROM library l WHERE l.id LIKE :library_id_p", nativeQuery = true)
    public Optional<Library> getLibraryById(@Param("library_id_p") Long library_id);
    @Modifying
    @Transactional
